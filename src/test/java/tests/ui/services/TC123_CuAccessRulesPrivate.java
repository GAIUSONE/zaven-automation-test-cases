...
public class TC123_CuAccessRulesPrivate extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC123 -  Access Rules - Private";
		testDescription = "Create an RFP with Access Rules as Private";
		authors = "Samanthasree";
		category = "CU";
	}
	
	@Test
	public void cuAccessRulesPrivate() throws InterruptedException {
		...
		//Preview inputs
		rfp.clickAccessRule().clickPrivate().clickDone().clickSubmit();
		Thread.sleep(2000);	
