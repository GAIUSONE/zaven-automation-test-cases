...
public class TC049_PropSOWArbitration extends ProjectHooks{
	...
	@Test
	public void propSOWArbitration() throws InterruptedException {
		...
		psow2.clkPropSowArbitrationInvestigation().ExpPropSowArbitrationInvestigation("Proposal Comments").clkPropSowArbitrationCounterClaimse().ExpPropSowArbitrationCounterClaimse("Proposal Comments").
		clkPropSowArbitrationInitial().ExpPropSowArbitrationInitial("Proposal Comments").clkPropSowArbitrationExchange().ExpPropSowArbitrationExchange("Proposal Comments").clkPropSowArbitrationAdditional().
		ExpPropSowArbitrationAdditional("Proposal Comments").clkPropSowArbitrationHearing().ExpPropSowArbitrationHearing("Proposal Comments").clkPropSowArbitrationPostHearing().
		ExpPropSowArbitrationPostHearing("Proposal Comments").clkPropSowArbitrationSettlement().ExpPropSowArbitrationSettlement("Proposal Comments").clkPropSowArbitrationAppeal().ExpPropSowArbitrationAppeal("Proposal Comments").
		clkPropSowArbitrationEnforcement().ExpPropSowArbitrationEnforcement("Proposal Comments").clkPropSowArbitrationOther().ExpPropSowArbitrationOther("Proposal Comments");
