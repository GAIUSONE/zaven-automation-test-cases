...
public class TC012_CreateLSPRegistrationMail extends ProjectHooks{
	...
	public void CreateCuAccount() throws InterruptedException { 
		...
		lspreg.clickSignUp().clickSignUpAsLsp().clickemail("watin56111@acentni.com").clickAccessCode("3srchilul1wxmu").clickContinue();
		...
		("watin56111@acentni.com").typeCommunicationEmail("watin56111@acentni.com").typeAutomaticCc("watin56111@acentni.com").clickContinue();
		...
		Thread.sleep(3000);
		adm.typeSearch("watin56111@acentni.com").clickEmail().typeSendEmail("Test Mail Content").btnPreviewEmail().clickClosePreviewIcon().btnSendEmail();
