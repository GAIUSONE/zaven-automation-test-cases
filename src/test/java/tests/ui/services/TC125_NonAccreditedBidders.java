...
public class TC125_NonAccreditedBidders extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC125 -  Create an RFP with Non Accredited Users";
		testDescription = "Create an RFP with non accredited users";
		authors = "Samanthasree";
		category = "CU";
	}
	
	@Test
	public void nonAccreditedBidder() throws InterruptedException {
		...
		//Bidders inputs
		rfp.NonAccreditedLegalServicesProvidersOn().NonAccFirstName("samanthasree").NonAccLastName("CG").NonAccLspName("Test Automation Company").
		NonAccLspEmail("abc123@tgmail.com").clickPreviewRFP();
		Thread.sleep(2000);	
