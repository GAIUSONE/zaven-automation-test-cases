...
public class TC205_CuHelpCentreFAQTemplatesBank extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC205 - Corporate Help Centre FAQ Templates Bank";
	...
	@Test
	public void CuHelpCentreFAQTemplatesBank() throws InterruptedException {
		...
		String Actual  = "https://dev.zavenlegal.com/corporate/faq?section=template_bank";
