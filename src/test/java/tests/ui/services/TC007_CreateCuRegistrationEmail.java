...
public class TC007_CreateCuRegistrationEmail extends ProjectHooks{
	...
	public void CreateCuAccount() throws InterruptedException { 
		...
		Thread.sleep(2000);
		cureg.selectPhoneNumber("9003120988").typeEmail("testemailfakeid15@instrive.in")
		...
		adm.clickCorporate().typeSearch("testemailfakeid15@instrive.in").clickEmail().typeSendEmail("Test Email content").btnPreviewEmail()
		.clickClosePreviewIcon().btnSendEmail();
