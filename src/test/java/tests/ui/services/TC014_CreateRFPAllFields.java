...
public class TC014_CreateRFPAllFields extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC014 - Create an RFP with all fields";
		testDescription = "Create an RFP with all fields";
