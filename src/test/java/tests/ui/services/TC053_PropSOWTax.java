...
public class TC053_PropSOWTax extends ProjectHooks{
	...
	@Test
	public void propSOWTax() throws InterruptedException {
		...
		psow2.clkPropSowTaxType().ExpPropSowTaxType("Proposal Comments").clkPropSowTaxTransactionalTax().ExpPropSowTaxTransactionalTax("Proposal Comments").
		clkPropSowTaxInvestigationAndDispute().ExpPropSowTaxInvestigationAndDispute("Proposal Comments").clkPropSowTaxTransferPricing().ExpPropSowTaxTransferPricing("Proposal Comments").
		clkPropSowTaxIndirectTax().ExpPropSowTaxIndirectTax("Proposal Comments").clkPropSowTaxTaxPlanning().ExpPropSowTaxTaxPlanning("Proposal Comments").
		clkPropSowTaxTaxPolicy().ExpPropSowTaxTaxPolicy("Proposal Comments").clkPropSowTaxTypeOther().ExpPropSowTaxTypeOther("Proposal Comments").clkPropSowTaxStagedApproach().
		ExpPropSowTaxStagedApproach("Proposal Comments").clkPropSowTaxImplementation().ExpPropSowTaxImplementation("Proposal Comments").clkPropSowTaxCorporateInCharge().
		ExpPropSowTaxCorporateInCharge("Proposal Comments").clkPropSowTaxAdviseOnImplementation().ExpPropSowTaxAdviseOnImplementation("Proposal Comments");
