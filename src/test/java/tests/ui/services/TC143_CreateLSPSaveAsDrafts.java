...
public class TC143_CreateLSPSaveAsDrafts extends ProjectHooks{
	...
	public void CreateLSPSaveAsDrafts() throws InterruptedException {
		...
		rfp.clickSaveDraft();
		Thread.sleep(2000);	
		String Actual  = getInnerText("//*[text()='Draft updated Successfully.']");
		String Expected = "Draft updated Successfully.";
		if(Actual.equals(Expected))
			System.out.println( "Pass - Draft updated Successfully.");
				else
