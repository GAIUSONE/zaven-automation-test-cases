...
public class TC126_RFPDiscloseBidders extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC126 -  Create an RFP and disclose bidders";
		testDescription = "Create an RFP and disclose bidders and no of bidders";
		authors = "Samanthasree";
		category = "CU";
	}
	
	@Test
	public void discloseBidders() throws InterruptedException {
		...
		//Bidders inputs
		rfp.clickSelectBidders().checkLegalServicesProviders().clickConfirm().discloseBiddersOn().discloseBidderName().
		discloseNoOfBidders().clickPreviewRFP();
		Thread.sleep(2000);		
