...
public class TC038_PropSOWCompetition extends ProjectHooks{
	...
	@Test
	public void propSowCommercialContracts() throws InterruptedException {
		...
		psow.clkPropSowCompetitionMerger().ExpPropSowCompetitionMerger("Proposal Comments").clkPropSowCompetitionAdvice().ExpPropSowCompetitionAdvice("Proposal Comments").
		clkPropSowCompetitionCartel().ExpPropSowCompetitionCartel("Proposal Comments").clkPropSowCompetitionAntitrust().ExpPropSowCompetitionAntitrust("Proposal Comments").
		clkPropSowCompetitionStateAid().ExpPropSowCompetitionStateAid("Proposal Comments").clkPropSowCompetitionBehaviouralAdvice().
		ExpPropSowCompetitionBehaviouralAdvice("Proposal Comments").clkPropSowCompetitionOther().ExpPropSowCompetitionOther("Proposal Comments").PropAdditionalInformation("Additional Information Comments");
		Thread.sleep(2000);
		rfp.clickContinue();
		Thread.sleep(2000);
