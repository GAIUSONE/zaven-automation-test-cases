...
public class TC045_ProSOWFundInvestment extends ProjectHooks{
	...
	@Test
public void propSOWFundInvestment() throws InterruptedException {
		...
		psow.clkPropSowFundInvestmentSummarising().ExpPropSowFundInvestmentSummarising("Proposal Comments").clkPropSowFundInvestmentNegotiating().ExpPropSowFundInvestmentNegotiating("Proposal Comments").
		clkPropSowFundInvestmentRelated().ExpPropSowFundInvestmentRelated("Proposal Comments").clkPropSowFundInvestmentAssistance().ExpPropSowFundInvestmentAssistance("Proposal Comments").
