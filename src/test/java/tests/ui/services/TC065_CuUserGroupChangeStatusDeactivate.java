...
public class TC065_CuUserGroupChangeStatusDeactivate extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC065 - Cu Deactivate Group status";
	...
	@Test
	public void CuUserGroupChangeStatusDeactivate() throws InterruptedException {
