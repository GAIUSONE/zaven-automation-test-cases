...
public class TC054_PropSOWOther extends ProjectHooks{
	...
	@Test
public void propSOWOther() throws InterruptedException {
		...
		psow2.clkPropSowOther().ExpPropSowOther("Proposal Comments");
