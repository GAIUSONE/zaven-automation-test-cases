...
public class TC174_LandingPageHeaderMenuContactUsFAQLink extends ProjectHooks{
	...
	@Test
	public void LandingPageHeaderMenuContactUsFAQLink() throws InterruptedException { 
		...
		home.headerMnuContact().contactUsFAQ();
		Thread.sleep(3000);
