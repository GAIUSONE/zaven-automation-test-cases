...
public class TC051_PropSOWInsolvancy extends ProjectHooks{
	...
	@Test
public void propSOWInsolvancy() throws InterruptedException {
		...
		psow2.clkPropSowInsolvencyRole().ExpPropSowInsolvencyRole("Proposal Comments").clkPropSowInsolvencyFormal().ExpPropSowInsolvencyFormal("Proposal Comments").
		clkPropSowInsolvencyLitigation().ExpPropSowInsolvencyLitigation("Proposal Comments").clkPropSowInsolvencyPurchase().ExpPropSowInsolvencyPurchase("Proposal Comments").
		clkPropSowInsolvencyAvoidance().ExpPropSowInsolvencyAvoidance("Proposal Comments").clkPropSowInsolvencyCommercialIssues().ExpPropSowInsolvencyCommercialIssues("Proposal Comments").
		clkPropSowInsolvencyInvestigations().ExpPropSowInsolvencyInvestigations("Proposal Comments").clkPropSowInsolvencyFraud().ExpPropSowInsolvencyFraud("Proposal Comments").
		clkPropSowInsolvencyOther().ExpPropSowInsolvencyOther("Proposal Comments");
