...
public class TC062_CuEditUserGroups extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC062 - CuEditUserGroups";
		testDescription = "Edit user group created and verigy update";
		authors = "Samanthasree";
		category = "CU";
	}
	
	@Test
	public void CuEditUserGroups() throws InterruptedException {
