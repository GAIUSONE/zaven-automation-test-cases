...
public class TC219_CreateProposalAllFieldsAddFiles extends ProjectHooks{
	
	@BeforeTest
	public void setReportValues() {
		testcaseName = "TC219 - Submit proposal with File uploads";
		testDescription = "Submit proposal with file uploads";
		authors = "Proposal";
	}
	
	@Test
	public void createProposalAllFieldsAddFiles() throws InterruptedException {
		...
		clickProposalConditionsApply().ExpandProposalConditionsApply("Proposal Comments").piAdditionalInformation("Proposal Comments").addFile();
		Thread.sleep(2000);			
		...
		PricingAdditionalInfo("Proposal Comments").addFile();
		Thread.sleep(2000);
		rfp.clickContinue();
		Thread.sleep(2000);
		...
		okiAdditionalInformation("Additional Information Comments").okiAddFile();
