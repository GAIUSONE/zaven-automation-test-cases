...
public class TC168_LandingPageHeaderMenuFAQRequestforProposals extends ProjectHooks{
	...
	@Test
	public void LandingPageHeaderMenuFAQRegistration() throws InterruptedException { 
		...
		home.headerMnuFAQ().headerMnuFAQRequestforProposals();
		Thread.sleep(3000);
